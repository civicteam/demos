...
/**
 * Handles Nexus client cache invalidation when server-modifying tools are called
 * This ensures that the Nexus client refreshes its tool list after servers are added/removed
 *
